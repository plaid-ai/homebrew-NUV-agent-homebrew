class NuvAgent < Formula
  ...
  url "https://github.com/plaid-ai/NUV-agent/releases/download/v0.1.20/nuv_agent-0.1.20.tar.gz"
  sha256 "9160d7131dd0bd1791cdb4999c214399aae2230dcedaaab3b1983952fc39102f"
  version "0.1.20"
  license "Proprietary"
