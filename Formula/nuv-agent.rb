class NuvAgent < Formula
  ...
  url "https://github.com/plaid-ai/NUV-agent/releases/download/v0.1.4/nuv_agent-0.1.4.tar.gz"
  sha256 "2e77e1a3fb1eca00ebfa48e62bce563dfb584afb469faf17183f47f667e14559"
  version "0.1.4"
  license "Proprietary"
